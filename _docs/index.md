...
### CML Models
As soon as you have installed our Eclipse plugin, you can start creating context maps. Start with a new contaxt map by creating a file with the file extension **.cml**.

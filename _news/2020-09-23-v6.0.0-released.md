 ...
 * [Service Cut Generator Improvements](#service-cut-generator-improvements)
   ...
   * New refactoring (model transformation) that allows to extract a suggested service in the original CML model.
